      ...
      <div class="items-center flex flex-wrap">
        <div class="w-full md:w-4/12 ml-auto mr-auto px-4">
          ...
          <p class="text-red-500 text-xs italic mb-5">
            Nhập mã số thẻ BHYT của các thành viên trong hộ gia đình (từng người
            một) để tra cứu mức đóng.
          </p>
                  ...
                  <div class="overflow-hidden">
                    ...
                    <table class="min-w-full">
                      ...
                      <tbody>
                        ...
                        >
                          ...
                          <td>
                            <button
                              class="text-pink-500 background-transparent font-bold uppercase px-3 py-1 text-xs outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                              type="button"
                              @click="remove(bhyt.maSoBhxh)"
                            >
                              Hủy
                            </button>
                          </td>
                    ...
                    <div class="flex items-center justify-between">
                      ...
                      <p class="text-xs">
                        ...
                        (Hoặc nộp tiền mặt trực tiếp tại Bưu điện xã Tự Lập cạnh
                        trạm y tế xã).
                      </p>
                    </div>
                  </div>
...
export default {
  filters: {
    ...
    soNgay(value) {
      ...
      if (value.coTheUuTienCaoHon === '1' || value.coTheUuTienCaoHon === true)
        return 'Có thẻ ưu tiên'
