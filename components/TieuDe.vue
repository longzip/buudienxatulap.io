<template>
    <div
      ...
      >
        <div
          class="absolute top-0 w-full h-full bg-center bg-cover" :style="`background-image: url('${bg ? bg : '/images/chi-tra-luong-huu-web.png'}');`"
        > 
          <span
            id="blackOverlay"
        ...
        >
          ...
          >
            <polygon
              class="text-yellow-200 fill-current"
